...
import co.iay.leetcode.Medium.HouseRobberII;
import org.junit.Assert;
import org.junit.Test;

public class TestHouseRobberII {
    private HouseRobberII h = new HouseRobberII();
    ...
    public void testHouseRobberCase4() {
        Assert.assertEquals(2, h.rob(new int[]{1, 1, 2}));
    }

    @Test
    public void testHouseRobberCase5() {
        Assert.assertEquals(6, h.rob(new int[]{2, 1, 3, 5}));
    }
